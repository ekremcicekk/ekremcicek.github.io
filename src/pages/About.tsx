...
export default function About() {
  return (
    <>
      <Seo
        title="About"
        description="About Ekrem Cicek, a 3D artist, game artist and Unity developer."
        path="/about"
      />
      ...
      <section className="container-page py-16 md:py-20">
        ...
        <div className="mt-8 grid gap-12 md:grid-cols-[2fr_1fr]">
          <div className="space-y-5 text-base leading-relaxed text-muted md:text-lg">
            <p>
              Ekrem Cicek is a 3D artist, game artist and Unity developer who has contributed to{" "}
            ...
            <p>
              ...
              release, publishing, and store presence.
            </p>
          </div>
